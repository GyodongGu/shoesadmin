...
<body>
	...
	<div>
		<div class="card text-center" style="width: 900px; margin: 0 auto;">
			...
			<div class="card-body">
				<form method="post" action="${contextPath}/view/Admin/eventManage.jsp">
					<input type="text" id="extraaddr1" class="form-control" placeholder="공지사항 제목">
					<br>
					<textarea class="form-control" id="exampleFormControlTextarea1" rows="15" cols="40" placeholder="공지사항 내용을 입력해주세요"></textarea>
					<br>
