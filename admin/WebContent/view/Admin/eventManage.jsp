			...
			<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<a class="nav-link" href="${pageContext.request.contextPath}/view/Admin/sMemManage.jsp">
							판매 회원 관리
						</a>
						
						<a class="nav-link" href="${pageContext.request.contextPath}/view/Admin/backup.jsp">
							구매 회원 탈퇴 후  백업 거래 내역
						</a>
						<a class="nav-link" href="${pageContext.request.contextPath}/view/Admin/codeManage.jsp">
							코드ID
						</a>
						<a class="nav-link" href="${pageContext.request.contextPath}/view/sMem/charts.jsp">
							매출
						</a>
						<!-- // 사이드바 추가 관리 메뉴들 -->
					</div>
