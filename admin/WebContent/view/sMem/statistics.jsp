...
<body>
				...
				<div class="card mb-4">
					...
					<div class="card-body">
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<button class="btn btn-primary" onclick="${contextPath}">확인</button>
							</div>
						</div>
	...
	<script>
		...
		function youshoesYearChart(datas) {
			...
			var varbackgroundColor = [ 'rgba(255, 99, 132, 0.2)', 'rgba(54, 162, 235, 0.2)', 'rgba(255, 206, 86, 0.2)', 'rgba(75, 192, 192, 0.2)', 'rgba(153, 102, 255, 0.2)' ]
			var varBorderColor = [ 'rgba(255,99,132,1)','rgba(54, 162, 235, 1)', 'rgba(255, 206, 86, 1)','rgba(75, 192, 192, 1)', 'rgba(153, 102, 255, 1)','rgba(255, 159, 64, 1)' ]
